...
| product-headings | Non-article heading classes, sans-serif. E.g. `o-typography-product-heading-level-1`                                                                                                                                                      | master                       |
| product-wrapper  | A class `o-typography-wrapper--product`, which acts like the wrapper feature described above, but with non-article/product headings.                                                                                                      | master                       |
